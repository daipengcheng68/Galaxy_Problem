...
function getUnitOfGalaxy(line: string[]) {
...
function getUnitPriceInGalaxy(line: string[]) {
...
function checkQuestions(splitLine: string[]) {
...
function romanToInt(sliceArray: string[]) {
    var findRoman = "";
    var romanNum = [];
    // var finalValue = 0;
